...
class CustomerAdmin(ExportMixin, UserAdmin):
    ...
    list_display = ("email", "username", "trader_id", "is_active", "test_period_expiration", "trades_today", "created_at")
    list_filter = ("is_active",)
    search_fields = ("email", "username", "trader_id")
    readonly_fields = ("created_at", "updated_at")
    fieldsets = (
        (None, {"fields": ("email", "username", "trader_id", "password", "country", "avatar")}),
